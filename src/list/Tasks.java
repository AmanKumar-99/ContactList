...
public class Tasks {Scanner scanner = new Scanner(System.in);
    LinkedList<String> linkedList = new LinkedList<String>();

    public void addContact(MyLinkedList linkedList1) {
    ...
    public void viewcontact(MyLinkedList linkedList1) {
    ...
    public void deleteContact(MyLinkedList linkedList1) {
        if (!linkedList1.isEmpty()) {
    ...
    public void searchContact(MyLinkedList linkedList1) {
